    ...
    this.each(function() {
      ...
      _public.native_commands = function() {
        ...
        _public.register("command", {
          name: "history",
          method: function(cmd) {
            if (Object.prototype.hasOwnProperty.call(cmd, "clear")) {
              history = [];
        ...
        _public.register("command", {
          ...
          method: function(cmd) {
            if (typeof cmd[1] === "string" && cmd[1].length > 0) {
              if (
                Object.prototype.hasOwnProperty.call(cmd, "-a") ||
                Object.prototype.hasOwnProperty.call(cmd, "--all")
              ) {
      ...
      _public.native_responses = function(cmd_opts) {
        for (var opt in cmd_opts) {
          if (Object.prototype.hasOwnProperty.call(cmd_opts, opt)) {
      ...
      _public.unregister = function(method_type, method_name) {
        ...
        if (
          ...
          Object.prototype.hasOwnProperty.call(method_name, "name")
        ) {
        ...
        if (
          ...
          Object.prototype.hasOwnProperty.call(callbefores, method_name)
        ) {
          flag = true;
          delete callbefores[method_name];
        } else if (
          method_type == "command" &&
          Object.prototype.hasOwnProperty.call(commands, method_name)
        ) {
          flag = true;
          delete commands[method_name];
        } else if (
          method_type == "response" &&
          Object.prototype.hasOwnProperty.call(responses, method_name)
        ) {
          flag = true;
          delete responses[method_name];
        } else if (
          method_type == "callback" &&
          Object.prototype.hasOwnProperty.call(callbacks, method_name)
        ) {
          flag = true;
      ...
      _public.register = function(method_type, obj) {
        var ret = false;
        if (obj) {
          var method_name = Object.prototype.hasOwnProperty.call(obj, "name")
              ? obj.name
              : false,
            method_exe = Object.prototype.hasOwnProperty.call(obj, "method")
              ? obj.method
              : false,
            method_options = Object.prototype.hasOwnProperty.call(
              obj,
              "options"
            )
              ? obj.options
              : [],
            method_help = Object.prototype.hasOwnProperty.call(obj, "help")
              ? obj.help
              : "";
      ...
      _public.get_command_option = function(options_mix) {
        ...
        if (typeof options_mix === "string") {
          out = Object.prototype.hasOwnProperty.call(cmd_opts, options_mix)
      ...
      var cmd_response = function(cmd_obj) {
        if (typeof cmd_obj === "object") {
          ...
          for (var res in cmd_obj) {
            if (Object.prototype.hasOwnProperty.call(responses, res)) {
      ...
      var cmd_callback = function() {
        if (cmd_obj) {
          // run callback if any
          if (Object.prototype.hasOwnProperty.call(callbacks, cmd_name)) {
